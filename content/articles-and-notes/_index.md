...
<div style="display: flex; flex-direction: column; gap: 1.5rem; margin-top: 3rem; margin-bottom: 2rem; max-width: 400px;">
  <!-- Top: 4:5 Image -->
  <div>
    <img src="/portfolio/images/articles/z2.jpg" alt="Article Cover" style="width: 100%; aspect-ratio: 4/5; object-fit: cover; background: #f0f0f0;">
  </div>
  ...
  <div>
    ...
    <a href="/portfolio/pdfs/Salvi_C.Alex_ThesisSummaryArticle.pdf" target="_blank" style="font-size: 1rem; text-decoration: underline; color: inherit; opacity: 0.8;">
      Read Article (PDF)
    </a>
  </div>
</div>
